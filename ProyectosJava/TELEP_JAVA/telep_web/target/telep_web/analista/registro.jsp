...
Proyecto: TELEP_APP
Descripción:
    Vista encargada de permitir al analista registrar
    información técnica de equipos asociados a clientes.
    Solo accesible para usuarios con rol ANALISTA (rolId = 2).
Tipo: Vista (JSP)
Autor: Julio Lopez
--%>
...
<%--
    ...
    tenga rol ANALISTA. Si no cumple, redirige al login.
--%>
<%
...
<%-- Título principal del panel de registro técnico --%>
...
<%--
    ...
    RegistroAnalistaServlet para ser almacenados en la BD.
--%>
